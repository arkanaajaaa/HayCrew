...
import 'package:haycrew_app/controllers/CStorage/riwayat_gudang_controller.dart';
...
class _RiwayatStoragePageState extends State<RiwayatStoragePage> {
  final RiwayatGudangController controller = Get.find<RiwayatGudangController>();
